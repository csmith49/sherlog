...
@click.option("--learning-rate", default=0.05, help="The learning rate of the optimizer")
@click.option("--mcmc-size", default=5, help="The number of samples used to approximate a gradient")
