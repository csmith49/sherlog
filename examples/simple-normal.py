...
def sample(mu : float = 0.5, sigma = 0.01):
...
# optimize
optimizer = Optimizer(program, learning_rate=1e-2)

for batch in minibatch(data, batch_size=10, epochs=100):
